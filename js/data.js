...
export const projects = [
  { title: 'Process',      type: 'Sound Design Reel',      palette: ['#0c0d11', '#c9a063', '#e8e2d8'], src: 'works/0.Process.mp4', previewSrc: 'works/previews/0.Process.mp4' },
  { title: 'Dune',         type: 'Trailer Sound Redesign', palette: ['#14100a', '#c9995c', '#f0e4d0'], src: 'works/1.Dune.mp4', previewSrc: 'works/previews/1.Dune.mp4' },
  { title: 'NEVO Trailer', type: 'Cinematic Trailer',      palette: ['#0a0e12', '#8fa3b0', '#e4ebf0'], src: 'works/2.NEVO Trailer.mp4', previewSrc: 'works/previews/2.NEVO Trailer.mp4', previewScale: 1.22 },
  { title: 'Pressure',     type: 'Tension Sound Design',   palette: ['#100a0a', '#a8574f', '#f0ded6'], src: 'works/3.Pressure.mp4', previewSrc: 'works/previews/3.Pressure.mp4' },
  { title: 'Dead Space',   type: 'Game Audio Redesign',    palette: ['#080b0c', '#7d9296', '#dde6e6'], src: 'works/4.Dead Space.mp4', previewSrc: 'works/previews/4.Dead Space.mp4' },
  { title: 'Chainsaw Man', type: 'Anime Sound Redesign',   palette: ['#140909', '#c05a3c', '#f5dcc8'], src: 'works/5.Chainsaw Man.mp4', previewSrc: 'works/previews/5.Chainsaw Man.mp4' },
  { title: 'Raihan-002',   type: 'Music Video Sound',      palette: ['#080e10', '#6f9298', '#e8eeea'], src: 'works/6.Raihan-002.mp4', previewSrc: 'works/previews/6.Raihan-002.mp4', previewScale: 1.2 },
  { title: 'GhostCode',    type: 'Sci-Fi Interface Audio', palette: ['#060a0b', '#7fa89c', '#dfeae5'], src: 'works/7.GhostCode.mp4', previewSrc: 'works/previews/7.GhostCode.mp4' },
];
